...
const Home: FC = () => {
  return (
    <div className="lg:min-h-[23rem] min-h-[18rem] max-h-full  w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md">
      ...
      <div className="lg:w-[40rem] w-[32rem] h-32 relative">
        <div className="absolute inset-x-20 top-0 bg-gradient-to-r from-transparent via-red-600 to-transparent h-[1px] w-3/4 blur-sm" />
        <div className="absolute inset-x-20 top-0 bg-gradient-to-r from-transparent via-sky-600 to-transparent h-px w-3/4" />
        <div className="absolute inset-x-60 top-0 bg-gradient-to-r from-transparent via-sky-600 to-transparent h-[3px] w-1/4 blur-sm" />
